...
const MainContent = ({title, number, content}) => {
    return (
    <div className = "h-[370px] border border-[0.5px] border-white/20 flex flex-row items-center border-x-black border-t-black px-[90px]">
        ...
        <div className = "w-[800px] flex flex-col text-white text-[70px] font-geist mt-[20px] text-[180px] mb-[70px] ml-[40px]">
        {title}
        </div>
        <div className = "text-white text-[180px] mb-[40px]"><FaArrowRight /></div>
    </div>
    )
}
  ...
  return (
    <div className = "w-screen h-max bg-black py-[90px]">
      ...
      <div className = "flex flex-col">
        <MainContent number = "1" title = "Buy" content = "Buy smarter with expert agents backed by mortgage, legal, and appraisal pros—dialed in to get you the best deal, fast. We've done this over 10,000 times, and we know what wins."/>
        <MainContent number = "2" title = "Sell" content = "Sell fast, sell high. Your listing gets pro staging, strategic pricing, constant open houses, and agents who never stop working until the right buyer signs."/>
        <MainContent number = "3" title = "Rent" content = "Access hidden rentals before they hit the market through agents who know every landlord in town. With decades of NYC experience, we unlock the best deals you won't find online."/>
      </div>
